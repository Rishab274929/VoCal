          ...
          child: AnimatedBuilder(
            ...
            builder: (_, __) {
              ...
              return Stack(
                alignment: Alignment.center,
                children: [
                  // The mic is the only saturated color in the entire app.
                  // Red halos expand outward (live / recording), the orb
                  // ring is micRed (THE red circle around the microphone),
                  // and the mic glyph + tick marks stay white so the red
                  // reads purely as the boundary signal.
                  Transform.scale(
                    scale: 1 + 0.7 * p,
                    child: Opacity(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: Palette.micRed.withOpacity(0.55),
                              width: 1.5),
                        ),
                      ),
                    ),
                    ...
                    child: Opacity(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(
                              color: Palette.micRed.withOpacity(0.35),
                              width: 1),
                        ),
                      ),
                    ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: Palette.ink,
                      border: Border.all(color: Palette.micRed, width: 2),
                      boxShadow: [
                        BoxShadow(
                            color: Palette.micRed.withOpacity(0.45),
                            blurRadius: 14),
                      ],
                    ),
                  ),
